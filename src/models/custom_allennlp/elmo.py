...
import logging
import warnings
from typing import Any, Dict, List, Tuple, TypeVar, Iterator, Union
...
from models.custom_allennlp.elmo_dependencies.file_utils import cached_path
from models.custom_allennlp.elmo_dependencies.params import Params
from models.custom_allennlp.elmo_dependencies.elmo_lstm import ElmoLstm
from models.custom_allennlp.elmo_dependencies.highway import Highway
from models.custom_allennlp.elmo_dependencies.scalar_mix import ScalarMix
from models.custom_allennlp.elmo_dependencies.elmo_indexer import ELMoCharacterMapper, ELMoTokenCharactersIndexer
from models.custom_allennlp.elmo_dependencies.dataset import Batch
from models.custom_allennlp.elmo_dependencies.token import Token

from models.custom_allennlp.elmo_dependencies.instance import Instance

from models.custom_allennlp.elmo_dependencies.vocabulary import Vocabulary
from models.custom_allennlp.elmo_dependencies.text_field import TextField
...
class _ElmoCharacterEncoder(torch.nn.Module):
    ...
    def forward(self, inputs: torch.Tensor) -> Dict[str, torch.Tensor]:  # pylint: disable=arguments-differ
        ...
        if cnn_options['activation'] == 'tanh':
            ...
            raise IOError("Unknown activation")
...
class _ElmoBiLm(torch.nn.Module):
    ...
    def __init__(self,
        ...
        if not options['lstm'].get('use_skip_connections'):
            raise IOError('We only support pretrained biLMs with residual connections')
    ...
    def create_cached_cnn_embeddings(self, tokens: List[str]) -> None:
        ...
        from models.custom_allennlp.elmo_dependencies.embedding import Embedding # type: ignore
