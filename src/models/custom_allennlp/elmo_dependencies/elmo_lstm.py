...
from models.custom_allennlp.elmo_dependencies.lstm_cell_with_projection import LstmCellWithProjection
from models.custom_allennlp.elmo_dependencies.encoder_base import _EncoderBase
...
class ElmoLstm(_EncoderBase):
    ...
    def _lstm_forward(self,
        ...
        if initial_state is None:
            ...
            raise IOError("Initial states were passed to forward() but the number of "
