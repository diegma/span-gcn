...
from models.custom_allennlp.elmo_dependencies.registrable import Registrable
from models.custom_allennlp.elmo_dependencies.tqdm import Tqdm
from models.custom_allennlp.elmo_dependencies import instance as adi  # pylint: disable=unused-import
...
def _read_pretrained_tokens(embeddings_file_uri: str) -> List[str]:
    ...
    from models.custom_allennlp.elmo_dependencies.embedding import EmbeddingsTextFile
...
class Vocabulary(Registrable):
    ...
    def _extend(self,
        ...
        for namespace in current_namespaces & extension_namespaces:
            ...
            if original_padded != extension_padded:
                raise IOError("Common namespace {} has conflicting ".format(namespace)+
    ...
    def __str__(self) -> str:
        ...
        non_padded_namespaces = "\tNon Padded Namespaces: "+str(self._non_padded_namespaces)+"\n"
    ...
    def __repr__(self) -> str:
        ...
        base_string = "Vocabulary with namespaces: "
        namespaces = [str(name)+", Size: "+str(self.get_vocab_size(name))+" ||"
                      for name in self._index_to_token]
        non_padded_namespaces = "Non Padded Namespaces: "+str(self._non_padded_namespaces)+""
