...
import warnings
import itertools
from typing import Optional, Tuple, Sequence, cast, IO, Iterator, NamedTuple
...
from models.custom_allennlp.elmo_dependencies.tqdm import Tqdm
from models.custom_allennlp.elmo_dependencies.file_utils import get_file_extension, cached_path
from models.custom_allennlp.elmo_dependencies.vocabulary import Vocabulary
from models.custom_allennlp.elmo_dependencies.token_embedder import TokenEmbedder
from models.custom_allennlp.elmo_dependencies.time_distributed import TimeDistributed
from models.custom_allennlp.elmo_dependencies import util
    ...
    def __init__(self,
        ...
        if weight is None:
            ...
            if weight.size() != (num_embeddings, embedding_dim):
                raise IOError("A weight matrix was passed with contradictory embedding shapes.")
            self.weight = torch.nn.Parameter(weight, requires_grad=trainable)
...
def _read_embeddings_from_text_file(file_uri: str,
    ...
    if not embeddings:
        raise IOError("No embeddings of correct dimension found; you probably "
